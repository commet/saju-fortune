  ...
  return (
    <div className="no-scrollbar flex items-center gap-2 overflow-x-auto pb-1">
      ...
      <button onClick={onAdd}
        className="flex shrink-0 items-center gap-1 rounded-lg border border-dashed border-[var(--border)] px-3.5 py-2.5 text-[13px] text-[var(--ink-muted)] transition-all hover:border-[var(--accent-soft)] hover:text-[var(--accent)]">
