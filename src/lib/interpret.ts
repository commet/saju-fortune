...
const DM: Record<string, {
  ...
  을: {
    ...
    personality: "전형적인 외유내강입니다. 겉으로는 부드럽고 순해 보이는데, 속은 꽤 단단해요. 눈치가 빠르고 사교성이 좋아서 어디 가든 잘 어울리는 타입이고, 예술적 감각도 타고난 편입니다.\n\n대신 결정을 내리는 데 시간이 좀 걸려요. 이것저것 따져보다가 타이밍을 놓칠 수 있고, 남의 눈치를 너무 보다가 정작 자기 의견을 잃어버리는 경우도 있습니다. 또한 겉은 맞춰주는 것 같아도, 마음속으로 이미 정한 게 있으면 결국 그대로 가는 편이에요.",
  ...
  무: {
    ...
    personality: "듬직하고 포용력이 커서 주변에 안정감을 줍니다. \"이 사람한테 맡기면 안심이다\"라는 소리를 듣는 타입이에요. 책임감이 강하고 신뢰를 중시하며, 약속을 잘 지킵니다.\n\n산이 쉽게 안 움직이듯, 한번 자리 잡으면 잘 안 바뀌는 면이 있어요. 변화를 꺼리고 익숙한 걸 선호하며, 자기 방식에 대한 확신이 강합니다. 주변에서는 고집이라고 느낄 수 있지만, 본인은 \"검증된 길\"을 가는 거라고 생각해요.\n\n보수적인 성향이 기회를 놓치게 할 수도 있습니다. 가끔은 모험도 필요합니다.",
    strengths: "안정적이고 믿음직합니다. 큰 프로젝트를 맡아서 끝까지 해내는 능력이 있고, 주변에 안정감을 줘요.",
    challenges: "변화에 느리고, 내 방식에 대한 고집이 있어요. \"지금 이대로가 좋은데...\"라는 생각이 발목을 잡을 수 있습니다.",
  ...
  기: {
    ...
    personality: "겸손하고 실용적인 사람이에요. 화려하진 않지만 꼼꼼하고 단단합니다. 누군가를 돌보고 지원하는 데서 보람을 느끼는 타입이고, 내적으로는 풍요로운 편입니다.\n\n그런데 흙이라는 게 한번 굳으면 잘 안 바뀌잖아요? 기토도 마찬가지입니다. 겉으로는 순해 보이지만, 속으로 정한 건 잘 안 바꿔요. 주변에서는 고집이 세다고 느낄 수 있는데, 본인은 \"이게 맞으니까\"라고 생각하는 거예요.\n\n또 걱정이 좀 많은 편이에요. 자기 확신이 부족해서 기회가 와도 \"내가 할 수 있을까...\" 하며 망설이는 경우가 있습니다.",
    strengths: "디테일에 강하고, 사람을 키우는 능력이 탁월합니다. 꼼꼼함으로는 타의 추종을 불허해요.",
    challenges: "겉으로는 순해 보여도 속 고집이 있어요. 또 소극적일 때가 있는데, \"나는 안 돼\"보다 \"한번 해볼까\"하는 마음이 인생을 바꿉니다.",
    career: "교육, 요식업, 회계, HR, 돌봄 관련 등 사람을 돌보거나 디테일이 필요한 분야가 잘 맞아요.",
    relationship: "헌신적이고 세심한 파트너예요. 다만 속으로 삭이지 말고 마음을 표현하는 연습이 관계를 건강하게 만듭니다.",
  },
  경: {
  ...
  신: {
    ...
    personality: "완벽주의 성향이 있고, 미적 감각과 분석력이 뛰어납니다. 자존심이 강하고 품격을 중시하는 사람이에요. 겉은 차가워 보일 수 있는데, 가까운 사람에게는 뜻밖에 따뜻합니다.\n\n보석이 단단하듯이, 이 사람도 내면이 상당히 강해요. 남한테 쉽게 휘둘리지 않고, 자기 기준이 확실합니다. \"이건 아닌데\"라고 생각하면 겉으로는 조용히 넘어가도, 속으로는 절대 수긍 안 합니다.\n\n대신 예민하고 까다로운 면이 있어서, 본인도 피곤해질 때가 있어요. 기준이 높은 건 좋지만, 모든 걸 완벽하게 하려다 지치는 경우가 있습니다.",
  ...
  임: {
    ...
    relationship: "지적인 교감이 중요한 파트너예요. 깊이 있는 대화가 이 사람과 가까워지는 가장 빠른 길입니다.",
  },
  계: {
    title: "계수(癸水)", nature: "음수", symbol: "빗물, 이슬, 안개",
    intro: "빗물이나 이슬 같은 존재입니다. 조용하지만 어디에나 스며들고, 없으면 메마르게 되는 물이에요.",
    personality: "겉은 조용한데, 내면에 깊은 세계가 있는 사람이에요. 직관력과 영감이 풍부해서, 남들이 못 보는 걸 느끼는 능력이 있습니다. 학문적 소양이 깊고, 인내심도 강한 편이에요.\n\n이슬이 조용히 스며들듯, 이 사람도 자기만의 방식이 있어요. 겉으로 강하게 주장하는 타입은 아닌데, 속으로 이미 판단이 끝나있는 경우가 많습니다. 조용하다고 만만하게 보면 안 돼요.\n\n대신 내성적이라 자기 표현이 서툴 수 있어요. 좋은 생각이 있어도 말을 안 해서 묻히는 경우가 있습니다. 표현력을 키우면 인생이 확 달라집니다.",
